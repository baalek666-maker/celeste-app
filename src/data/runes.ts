...
export const ELDER_FUTHARK: RuneData[] = [
  ...
  },
  {
    ...
    upright: "Force vitale, sante, energie brute. Le pouvoir de modeler ton destinee par la volonte et l endurance.",
  ...
  },
  {
    ...
    upright: "Voyage, mouvement, quete spirituelle. Tu es sur le bon chemin, le voyage est aussi important que la destination.",
  ...
  },
  {
    ...
    reversed: "Detresse, oppression, mauvaise gestion de l energie. Resistez a la detresse en acceptant tes limites.",
    element: "Feu",
    planet: "Saturne",
    zodiac: "Verseau",
    keyword: "Besoin",
